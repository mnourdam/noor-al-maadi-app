...
-- Production migration version: 20260901103506
-- md5(statement) = 8e380637582c14a0cf9385d69f6ee36e  length = 2829
-- Copied verbatim from supabase_migrations.schema_migrations on 2026-09-05.
-- HISTORICAL PREDECESSOR of the current authority. This version still writes
-- a CLIENT-SUPPLIED `streak`. Superseded by 20260905130745 (V17-04B).
