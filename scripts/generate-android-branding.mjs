...
function writeVectors() {
  ...
  // Splash icon for the Android 12+ SplashScreen API. Keep it as a plain
  // transparent vector, not an adaptive-icon wrapper: the previous adaptive
  // wrapper still allowed OEM/system fallback paths to show a dark icon plate.
  // The launch theme supplies the navy background separately.
  write(join(RES, "drawable-anydpi-v26", "ic_splash_icon.xml"), fgVector);
