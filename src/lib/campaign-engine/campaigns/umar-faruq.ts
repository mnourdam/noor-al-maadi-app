  ...
  chapters: [
    {
      ...
      intro:
        "في ظهيرة الإثنين الثاني عشر من ربيع الأوّل سنة ١١هـ، تنتقل روح النبي ﷺ إلى الرفيق الأعلى. تضطرب المدينة، ويهرع الأنصار إلى سقيفة بني ساعدة. هناك يحسم عمرُ المشهدَ ببيعته لأبي بكر، فتُحفظ الدولة قبل أن تنهار.",
      body: [
    ...
    },
    {
      ...
      intro:
        "في جمادى الآخرة سنة ١٣هـ يُتوفّى أبو بكر، فيوصي بالخلافة لعمر بعد مشاورةٍ مع كبار الصحابة. يقف الفاروق على المنبر مُرتبكًا من ثقل الأمانة: \"إنّي أُعفيت من أمرين: الفيء، والقَسَم… ولا قوّة إلا بالله\".",
      body: [
    ...
    },
    {
      ...
      intro:
        "في رجب سنة ١٥هـ، يلتقي أربعون ألفًا من المسلمين بقيادة خالد بن الوليد وأبي عبيدة بنحو مئتي ألفٍ من جيش هرقل على ضفاف اليرموك. ستة أيامٍ من القتال تحت رياح الصحراء تنتهي بانهيار الجيش البيزنطي، ويُنزع الشامُ من الروم إلى الأبد.",
      body: [
      ...
      quiz: {
        ...
        questions: [{
          ...
          correctIndex: 1,
          explanation: "حسمت اليرموك سنة ١٥هـ سقوط الشام بعد ستة أيام من القتال.",
          xp: 40,
        }],
      },
    },
    ...
    },
    {
      ...
      quiz: {
        ...
        questions: [{
          ...
          correctIndex: 2,
          explanation: "المدائن عاصمة كسرى الساساني، فتحها سعد سنة ١٦هـ.",
          xp: 40,
        }],
      },
    },
    ...
    },
    {
      ...
      intro:
        "حين كثرت المراسلات بين الأمصار التبست التواريخ، فاستشار عمرُ الصحابة في مبدأٍ للتاريخ. قال علي: \"نؤرّخ من هجرة النبي ﷺ، يوم فرّق بين الحقّ والباطل\". فأقرّ عمرُ التقويم الهجريّ سنة ١٧هـ، وبدأ زمنُ الإسلام رسميًّا.",
      body: [
    ...
    },
    {
      ...
      intro:
        "في فجر الأربعاء السادس والعشرين من ذي الحجة سنة ٢٣هـ، يطعن أبو لؤلؤة المجوسي عمرَ بخنجرٍ ذي رأسين وهو في محرابه. يُحمل إلى داره فيوصي بالخلافة شورى بين ستةٍ من العشرة، ويُدفن إلى جانب صاحبيه في الحجرة النبويّة. تنتهي عشر سنواتٍ هزّت العالم.",
      body: [
      ...
      quiz: {
        ...
        questions: [
          ...
          },
          {
            ...
            correctIndex: 2,
            explanation: "تولّى الخلافة سنة ١٣هـ واستُشهد سنة ٢٣هـ.",
            xp: 50,
          },
        ],
      },
