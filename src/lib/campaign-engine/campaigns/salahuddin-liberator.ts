  ...
  chapters: [
    {
      ...
      quiz: {
        ...
        questions: [{
          ...
          correctIndex: 2,
          explanation: "وُلد صلاح الدين في تكريت سنة 1137م.",
          xp: 20,
        }],
      },
    },
    ...
    },
    {
      ...
      body: [
        ...
        "خطب صلاح الدين للخليفة العباسي على منابر مصر سنة 567هـ، فطُويت دولةٌ امتدت قرنين.",
      ],
      figures: [
        { kind: "character", id: "salahuddin", label: "صلاح الدين" },
    ...
    },
    {
      ...
      intro:
        "في تموز 583هـ، تستدرج الجيوش الصليبية إلى سفح قرني حطين تحت شمسٍ حارقة بلا ماء. تنتهي المعركة قبل أن تبدأ؛ ويسقط الصليب الذي حمله الفرنج.",
      body: [
    ...
    },
    {
      ...
      intro:
        "في 27 رجب 583هـ، تُفتح أبواب القدس صلحًا. يدخل صلاح الدين المسجد الأقصى ويُنصب فيه المنبر الذي وعد به نور الدين قبل اثنين وعشرين عامًا.",
      body: [
      ...
      quiz: {
        ...
        questions: [{
          ...
          choices: ["1071", "1187", "1258", "1453"],
          correctIndex: 1,
          explanation: "حُرِّرت القدس سنة 1187م في رجب 583هـ.",
          xp: 50,
        }],
      },
    },
