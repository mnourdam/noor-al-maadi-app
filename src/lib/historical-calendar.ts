...
export const CALENDAR_EVENTS: CalendarEvent[] = [
  // Prophetic era
  E({ id:"c-001", month:3, day:12, year:"624م/2هـ", era:"seerah", type:"battle",
      title:"غزوة بدر الكبرى",
      description:"أول معركة فاصلة في تاريخ الإسلام، انتصر فيها 313 مسلمًا على 1000 مشرك.",
      importance:3, hijriDay:17, hijriMonth:9,
      source:"السيرة النبوية لابن هشام" }),
  E({ id:"c-002", month:3, day:23, year:"625م/3هـ", era:"seerah", type:"battle",
      title:"غزوة أُحد",
  ...
  E({ id:"c-003", month:9, day:24, year:"622م/1هـ", era:"seerah", type:"event",
  ...
  E({ id:"c-004", month:7, day:16, year:"622م/1هـ", era:"seerah", type:"event",
  ...
  E({ id:"c-005", month:1, day:11, year:"630م/8هـ", era:"seerah", type:"event",
      title:"فتح مكة",
  ...
  E({ id:"c-006", month:6, day:8, year:"632م/11هـ", era:"seerah", type:"event",
      title:"وفاة النبي ﷺ",
  ...
  E({ id:"c-007", month:3, day:6, year:"627م/5هـ", era:"seerah", type:"battle",
      title:"غزوة الخندق",
  ...
  // Rashidun era
  E({ id:"c-010", month:8, day:23, year:"632م/11هـ", era:"rashidun", type:"figure",
  ...
  E({ id:"c-011", month:12, day:1, year:"634م/13هـ", era:"rashidun", type:"figure",
  ...
  E({ id:"c-012", month:8, day:20, year:"636م/15هـ", era:"rashidun", type:"battle",
      title:"معركة اليرموك",
  ...
  E({ id:"c-013", month:11, day:16, year:"636م/15هـ", era:"rashidun", type:"battle",
      title:"معركة القادسية",
      description:"هزم سعد بن أبي وقاص جيش الفرس بقيادة رستم، ففُتحت أبواب العراق.",
      importance:3, source:"تاريخ الطبري" }),
  E({ id:"c-014", month:4, day:15, year:"637م/16هـ", era:"rashidun", type:"event",
      title:"فتح بيت المقدس",
      description:"دخل عمر بن الخطاب القدس وكتب العهدة العمرية لأهلها.",
      importance:3, source:"تاريخ الطبري" }),
  E({ id:"c-015", month:12, day:26, year:"644م/23هـ", era:"rashidun", type:"event",
  ...
  E({ id:"c-016", month:6, day:17, year:"656م/35هـ", era:"rashidun", type:"event",
  ...
  E({ id:"c-017", month:1, day:27, year:"661م/40هـ", era:"rashidun", type:"event",
  ...
  E({ id:"c-018", month:7, day:7, year:"657م/37هـ", era:"rashidun", type:"battle",
      title:"معركة صفّين",
      description:"اشتباك علي ومعاوية على ضفاف الفرات، انتهى بقضية التحكيم.",
      importance:2, source:"تاريخ الطبري" }),

  // Umayyad era
  E({ id:"c-020", month:7, day:18, year:"661م/41هـ", era:"umayyad", type:"state",
  ...
  E({ id:"c-021", month:10, day:10, year:"680م/61هـ", era:"umayyad", type:"event",
      title:"معركة كربلاء",
  ...
  E({ id:"c-022", month:4, day:26, year:"711م/92هـ", era:"andalus", type:"battle",
      title:"معركة وادي لكّة",
      description:"هزم طارق بن زياد القوط بقيادة لذريق، ففُتحت الأندلس.",
      importance:3, source:"نفح الطيب · المقرّي" }),
  E({ id:"c-023", month:7, day:10, year:"732م/114هـ", era:"umayyad", type:"battle",
  ...
  E({ id:"c-024", month:1, day:25, year:"750م/132هـ", era:"abbasid", type:"battle",
      ...
      source:"تاريخ الطبري" }),
  E({ id:"c-025", month:8, day:6, year:"750م/132هـ", era:"umayyad", type:"event",
  ...
  E({ id:"c-026", month:5, day:14, year:"756م/138هـ", era:"andalus", type:"state",
  ...
  // Abbasid era
  E({ id:"c-030", month:11, day:28, year:"749م/132هـ", era:"abbasid", type:"figure",
      ...
      source:"تاريخ الطبري" }),
  E({ id:"c-031", month:7, day:30, year:"762م/145هـ", era:"abbasid", type:"city",
      title:"تأسيس بغداد",
  ...
  E({ id:"c-032", month:9, day:14, year:"786م/170هـ", era:"abbasid", type:"figure",
      ...
      source:"تاريخ الطبري" }),
  E({ id:"c-033", month:3, day:24, year:"809م/193هـ", era:"abbasid", type:"figure",
      ...
      source:"تاريخ الطبري" }),
  E({ id:"c-034", month:9, day:27, year:"813م/198هـ", era:"abbasid", type:"event",
      ...
      source:"تاريخ الطبري" }),
  E({ id:"c-035", month:8, day:13, year:"838م/223هـ", era:"abbasid", type:"battle",
      title:"فتح عمّورية",
      ...
      source:"تاريخ الطبري" }),
  E({ id:"c-036", month:7, day:1, year:"836م/221هـ", era:"abbasid", type:"city",
      title:"تأسيس سامراء",
  ...
  E({ id:"c-037", month:7, day:15, year:"751م/133هـ", era:"abbasid", type:"battle",
      title:"معركة طلاس",
  ...
  E({ id:"c-038", month:8, day:31, year:"870م/256هـ", era:"abbasid", type:"scholar",
  ...
  E({ id:"c-039", month:5, day:6, year:"875م/261هـ", era:"abbasid", type:"scholar",
  ...
  E({ id:"c-040", month:1, day:20, year:"820م/204هـ", era:"abbasid", type:"scholar",
      ...
      source:"سير أعلام النبلاء · الذهبي" }),
  E({ id:"c-041", month:7, day:31, year:"855م/241هـ", era:"abbasid", type:"scholar",
      title:"وفاة الإمام أحمد بن حنبل",
      description:"إمام أهل السنّة في محنة خلق القرآن، توفّي ببغداد عن نحو 77 عامًا.",
      importance:3, relatedEntityIds:["abbasid.figure.ibn-hanbal","abbasid.event.mihna"],
      source:"تاريخ بغداد" }),
  E({ id:"c-042", month:2, day:10, year:"1258م/656هـ", era:"abbasid", type:"event",
  ...
  E({ id:"c-043", month:10, day:14, year:"833م/218هـ", era:"abbasid", type:"event",
      title:"وفاة المأمون",
  ...
  // Ayyubid era
  E({ id:"c-050", month:1, day:1, year:"1138م/532هـ", era:"ayyubid", type:"figure",
  ...
  E({ id:"c-051", month:9, day:13, year:"1171م/567هـ", era:"ayyubid", type:"state",
  ...
  E({ id:"c-052", month:7, day:4, year:"1187م/583هـ", era:"ayyubid", type:"battle",
      title:"معركة حِطّين",
  ...
  E({ id:"c-053", month:10, day:2, year:"1187م/583هـ", era:"ayyubid", type:"event",
      title:"تحرير القدس",
      ...
      source:"النوادر السلطانية · ابن شدّاد" }),
  E({ id:"c-054", month:9, day:7, year:"1191م/587هـ", era:"ayyubid", type:"battle",
      title:"معركة أرسوف",
      ...
      source:"النوادر السلطانية · ابن شدّاد" }),
  E({ id:"c-055", month:9, day:2, year:"1192م/588هـ", era:"ayyubid", type:"event",
      title:"صلح الرملة",
      ...
      source:"النوادر السلطانية · ابن شدّاد" }),
  E({ id:"c-056", month:3, day:4, year:"1193م/589هـ", era:"ayyubid", type:"figure",
  ...
  E({ id:"c-057", month:11, day:5, year:"1174م/570هـ", era:"ayyubid", type:"event",
      ...
      source:"الكامل في التاريخ · ابن الأثير" }),
  E({ id:"c-058", month:2, day:8, year:"1250م/647هـ", era:"ayyubid", type:"battle",
  ...
  E({ id:"c-059", month:5, day:2, year:"1250م/648هـ", era:"ayyubid", type:"figure",
  ...
  // Late-era anchors
  E({ id:"c-070", month:9, day:3, year:"1260م/658هـ", era:"mamluk", type:"battle",
      title:"معركة عين جالوت",
      description:"هزم قطز وبيبرس المغول لأول مرة، فحُفظت مصر والشام.",
      importance:3, source:"السلوك · المقريزي" }),
  E({ id:"c-071", month:5, day:29, year:"1453م/857هـ", era:"ottoman", type:"event",
  ...
  E({ id:"c-072", month:1, day:2, year:"1492م/897هـ", era:"andalus", type:"city",
      title:"سقوط غرناطة",
  ...
  E({ id:"c-073", month:8, day:24, year:"1516م/922هـ", era:"ottoman", type:"battle",
  ...
  E({ id:"c-074", month:11, day:22, year:"1071م/463هـ", era:"seljuk", type:"battle",
      title:"معركة ملاذكرد",
  ...
  E({ id:"c-075", month:3, day:3, year:"1924م/1342هـ", era:"modern", type:"event",
