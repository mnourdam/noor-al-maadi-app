...
export const STORIES: Story[] = [
  ...
  },
  {
    ...
    body: [
      "في عام 15هـ، التقى جيش المسلمين بقيادة خالد بن الوليد بجيش الروم الضخم على ضفاف نهر اليرموك.",
  ...
  },
  {
    ...
    body: [
      "في عام 15هـ أيضًا، تقدّم سعد بن أبي وقاص بجيش المسلمين لمواجهة الفرس بقيادة رستم في سهل القادسية.",
  ...
  },
  {
    ...
    body: [
      "في الرابع من تموز 1187م، استدرج صلاح الدين الجيش الصليبي إلى سهل حِطّين القاحل.",
      ...
      "وبعد أشهر، دخل صلاح الدين القدس صلحًا، فعفا عن أهلها، وأعاد الأذان إلى المسجد الأقصى بعد 88 عامًا.",
    ],
  },
  {
    id: "ain-jalut",
    ...
    body: [
      "بعد سقوط بغداد عام 1258م، زحف المغول نحو الشام، وبدا أن لا شيء يوقفهم.",
      "جمع السلطان قطز جيشه ومعه قائده بيبرس، والتقى المغول في عين جالوت بفلسطين عام 1260م.",
  ...
  },
  {
    ...
    body: [
      "في الحادي والعشرين من عمره، قاد السلطان محمد الثاني جيشه لحصار القسطنطينية عام 1453م.",
      "بنى مدافع ضخمة لم يعرف العالم مثلها، وحفر سفنه فوق التلال ليُنزلها في القرن الذهبي.",
      "بعد 53 يومًا من الحصار، اقتحم المسلمون أسوار المدينة في الفجر.",
  ...
  },
  {
    ...
    era: "mamluk",
    readMinutes: 4,
    excerpt: "ثلاثون عامًا في الأسفار، و75 ألف ميلٍ قطعها قبل أن يخترع المحرّك.",
    body: [
      "خرج محمد بن عبد الله بن بطوطة من طنجة عام 1325م حاجًّا، فلم يعد إلا بعد 29 عامًا.",
      "زار مصر والشام والحجاز والعراق وفارس واليمن وشرق أفريقيا والهند والصين وجزر المالديف ومالي.",
      "قطع نحو 75 ألف ميل، ودوّن مشاهداته في كتابه «تحفة النظّار» الذي بقي أعظم رحلةٍ في تاريخ البشرية.",
    ],
  },
  {
    id: "nahda",
...
export const PUZZLES: Puzzle[] = [
  { id: "p1", era: "seerah", question: "في أي عامٍ ميلادي وُلد النبي محمد ﷺ؟", options: ["550 م", "570 م", "590 م", "610 م"], answerIndex: 1, hint: "عام الفيل.", explanation: "وُلد ﷺ في عام الفيل الموافق 570م تقريبًا." },
  ...
  { id: "p4", era: "rashidun", question: "أين وقعت معركة القادسية؟", options: ["العراق", "الشام", "مصر", "خراسان"], answerIndex: 0, hint: "قرب الكوفة.", explanation: "وقعت في العراق سنة 15هـ بقيادة سعد بن أبي وقاص." },
  { id: "p5", era: "umayyad", question: "من مؤسس الدولة الأموية؟", options: ["مروان بن الحكم", "معاوية بن أبي سفيان", "عبد الملك بن مروان", "الوليد بن عبد الملك"], answerIndex: 1, hint: "والي الشام.", explanation: "معاوية بن أبي سفيان أسّسها عام 41هـ واتّخذ دمشق عاصمة." },
  { id: "p6", era: "umayyad", question: "من فتح الأندلس؟", options: ["موسى بن نصير", "طارق بن زياد", "عبد الرحمن الغافقي", "عقبة بن نافع"], answerIndex: 1, hint: "أحرق السفن.", explanation: "طارق بن زياد عام 711م، وسُمّي جبل طارق باسمه." },
  { id: "p7", era: "abbasid", question: "من بنى مدينة بغداد؟", options: ["السفاح", "المنصور", "الرشيد", "المأمون"], answerIndex: 1, hint: "الخليفة الثاني.", explanation: "أبو جعفر المنصور عام 145هـ، وسمّاها مدينة السلام." },
  ...
  { id: "p12", era: "ayyubid", question: "في أي عامٍ هجري حرّر صلاح الدين القدس؟", options: ["573 هـ", "583 هـ", "593 هـ", "603 هـ"], answerIndex: 1, hint: "بعد حِطّين بأشهر.", explanation: "حرّرها في رجب 583هـ الموافق 1187م." },
  ...
  { id: "p14", era: "mamluk", question: "ما اسم الرحّالة الطنجي الشهير؟", options: ["ابن جبير", "ابن بطوطة", "ابن فضلان", "البيروني"], answerIndex: 1, hint: "كتابه «تحفة النظّار».", explanation: "محمد بن بطوطة الطنجي، طاف 75 ألف ميل في 29 سنة." },
  { id: "p15", era: "ottoman", question: "كم كان عمر محمد الفاتح حين فتح القسطنطينية؟", options: ["19", "21", "25", "30"], answerIndex: 1, hint: "في ربيع شبابه.", explanation: "كان عمره 21 سنة حين فتحها عام 1453م." },
  { id: "p16", era: "ottoman", question: "من أعظم سلاطين العثمانيين الذي بلغت الدولة في عهده ذروتها؟", options: ["سليم الأول", "سليمان القانوني", "محمد الفاتح", "بايزيد الثاني"], answerIndex: 1, hint: "عُرف عند الأوروبيين بالعظيم.", explanation: "سليمان القانوني، حكم 46 سنة وامتدّت الدولة في عهده إلى أقصاها." },
  { id: "p17", era: "abbasid", question: "في أي سنةٍ سقطت بغداد على يد هولاكو؟", options: ["648 هـ", "656 هـ", "660 هـ", "672 هـ"], answerIndex: 1, hint: "بعدها بعامين كانت عين جالوت.", explanation: "سقطت في صفر 656هـ الموافق 1258م." },
  ...
  { id: "p19", era: "umayyad", question: "من أول من ضرب الدينار الإسلامي الخالص؟", options: ["معاوية", "عبد الملك بن مروان", "هشام بن عبد الملك", "عمر بن عبد العزيز"], answerIndex: 1, hint: "عرّب الدواوين أيضًا.", explanation: "عبد الملك بن مروان عام 77هـ." },
  { id: "p20", era: "seerah", question: "في أي عامٍ هجري كانت غزوة بدر الكبرى؟", options: ["1 هـ", "2 هـ", "3 هـ", "5 هـ"], answerIndex: 1, hint: "أول معركة فاصلة.", explanation: "في رمضان من السنة الثانية للهجرة." },
];
...
export const WHO_AM_I: WhoAmI[] = [
  ...
  { id: "w4", era: "ayyubid", answer: "صلاح الدين الأيوبي", aliases: ["صلاح الدين", "الناصر صلاح الدين"], clues: ["كرديّ الأصل سلطانٌ على مصر والشام.", "هزمتُ الصليبيين في حِطّين.", "حرّرتُ القدس بعد 88 عامًا من الاحتلال."] },
  ...
  { id: "w6", era: "ottoman", answer: "محمد الفاتح", aliases: ["الفاتح", "محمد الثاني"], clues: ["تحقّقت بشارة النبي ﷺ على يدي.", "نقلتُ السفن فوق التلال.", "فتحتُ القسطنطينية وعمري 21 سنة."] },
...
export const ON_THIS_DAY: OnThisDay[] = [
  { id: "d1", monthDay: "01-15", year: "756م", era: "andalus", title: "تأسيس إمارة الأندلس الأموية", detail: "دخل عبد الرحمن الداخل قرطبة وأسّس الدولة الأموية في الأندلس.", source: "ابن الأثير · الكامل في التاريخ" },
  { id: "d2", monthDay: "02-10", year: "656هـ/1258م", era: "abbasid", title: "سقوط بغداد على يد هولاكو", detail: "اقتحم المغول بغداد وأنهَوا الخلافة العباسية، وأُلقيت كتب بيت الحكمة في دجلة.", source: "ابن كثير · البداية والنهاية" },
  { id: "d3", monthDay: "03-12", year: "624م", era: "seerah", title: "غزوة بدر الكبرى", detail: "أول معركة فاصلة في تاريخ الإسلام، انتصر فيها 313 مسلمًا على 1000 مشرك.", source: "السيرة النبوية لابن هشام" },
  { id: "d4", monthDay: "04-06", year: "1453م", era: "ottoman", title: "بداية حصار القسطنطينية", detail: "بدأ السلطان محمد الفاتح حصار المدينة الذي استمر 53 يومًا حتى فتحها.", source: "تاج التواريخ · سعد الدين" },
  { id: "d5", monthDay: "04-26", year: "711م", era: "andalus", title: "معركة وادي لكّة", detail: "هزم طارق بن زياد القوط بقيادة لذريق، ففُتحت الأندلس.", source: "نفح الطيب · المقري" },
  { id: "d6", monthDay: "05-29", year: "1453م", era: "ottoman", title: "فتح القسطنطينية", detail: "دخل محمد الفاتح المدينة وصلّى في آيا صوفيا، فتحقّقت بشارة النبي ﷺ.", source: "كرتسولاس · مؤرخ بيزنطي" },
  { id: "d7", monthDay: "06-08", year: "632م", era: "seerah", title: "وفاة النبي ﷺ", detail: "انتقل النبي محمد ﷺ إلى الرفيق الأعلى في المدينة المنورة.", source: "صحيح البخاري" },
  { id: "d8", monthDay: "07-04", year: "1187م", era: "ayyubid", title: "معركة حِطّين", detail: "هزم صلاح الدين الصليبيين هزيمةً ساحقة، فُتح الطريق لتحرير القدس.", relatedEntityId: "ayyubid.battle.hattin", source: "النوادر السلطانية · ابن شداد" },
  { id: "d9", monthDay: "08-10", year: "636م", era: "rashidun", title: "بداية معركة اليرموك", detail: "ستة أيامٍ من القتال انتهت بهزيمة الروم وفتح الشام.", source: "فتوح البلدان · البلاذري" },
  { id: "d10", monthDay: "09-03", year: "1260م", era: "mamluk", title: "معركة عين جالوت", detail: "هزم قطز وبيبرس المغول لأول مرة، فحُفظت مصر والشام.", source: "السلوك · المقريزي" },
  { id: "d11", monthDay: "10-02", year: "1187م", era: "ayyubid", title: "تحرير القدس", detail: "دخل صلاح الدين القدس صلحًا، وأُعيد الأذان إلى المسجد الأقصى.", relatedEntityId: "ayyubid.event.liberate-jerusalem", source: "ابن شداد · النوادر السلطانية" },
  { id: "d12", monthDay: "11-16", year: "636م", era: "rashidun", title: "معركة القادسية", detail: "هزم سعد بن أبي وقاص جيش الفرس بقيادة رستم." },
  { id: "d13", monthDay: "12-18", year: "1271م", era: "mamluk", title: "فتح بيبرس قلعة الحصن", detail: "حصن الصليبيين الأمنع في الشام سقط بيد المماليك." },
  { id: "d14", monthDay: "01-27", year: "732م", era: "umayyad", title: "معركة بلاط الشهداء", detail: "استشهد عبد الرحمن الغافقي في معركةٍ غيّرت مصير أوروبا." },
  { id: "d15", monthDay: "02-19", year: "1473م", era: "ottoman", title: "تأسيس مكتبة محمد الفاتح", detail: "أسّس الفاتح مكتبةً ضخمة جمع فيها مخطوطات الشرق والغرب." },
  { id: "d16", monthDay: "03-09", year: "786م", era: "abbasid", title: "تولية هارون الرشيد", detail: "تولّى الخلافة في ليلةٍ شهدت مولد ابنه المأمون ووفاة أخيه الهادي." },
  { id: "d17", monthDay: "03-30", year: "1492م", era: "andalus", title: "سقوط غرناطة", detail: "سلّم أبو عبد الله الصغير مفاتيح غرناطة، فانتهت ثمانية قرون من حكم المسلمين." },
  { id: "d18", monthDay: "04-21", year: "762م", era: "abbasid", title: "تأسيس بغداد", detail: "وضع المنصور حجر الأساس لمدينة السلام، فصارت عاصمة العالم القديم." },
  { id: "d19", monthDay: "05-04", year: "1277م", era: "mamluk", title: "وفاة الظاهر بيبرس", detail: "توفّي السلطان الذي وحّد مصر والشام ودكّ الصليبيين والمغول." },
  { id: "d20", monthDay: "06-15", year: "1215م", era: "ayyubid", title: "ولادة الملك الكامل", detail: "السلطان الأيوبي الذي ردّ الحملة الصليبية الخامسة عن مصر." },
  { id: "d21", monthDay: "07-15", year: "622م", era: "seerah", title: "الهجرة النبوية", detail: "بدأ النبي ﷺ هجرته من مكة إلى المدينة، وبدأ التقويم الهجري." },
  { id: "d22", monthDay: "08-25", year: "750م", era: "umayyad", title: "سقوط الدولة الأموية", detail: "هُزم مروان بن محمد في الزاب وانتقلت الخلافة إلى العباسيين." },
  { id: "d23", monthDay: "09-11", year: "1683م", era: "ottoman", title: "حصار فيينا الثاني", detail: "آخر زحف عثماني كبير على أوروبا، انتهى بانكسار العثمانيين." },
  { id: "d24", monthDay: "10-17", year: "1911م", era: "modern", title: "بداية المقاومة الليبية", detail: "بدأ عمر المختار جهاده ضد الاحتلال الإيطالي." },
  { id: "d25", monthDay: "11-04", year: "1040م", era: "seljuk", title: "معركة دندانقان", detail: "هزم السلاجقة الغزنويين فأسّسوا دولتهم في خراسان." },
  { id: "d26", monthDay: "11-22", year: "1071م", era: "seljuk", title: "معركة ملاذكرد", detail: "أسر السلطان ألب أرسلان إمبراطور الروم، وفُتح باب الأناضول للمسلمين." },
  { id: "d27", monthDay: "12-01", year: "634م", era: "rashidun", title: "وفاة أبي بكر الصدّيق", detail: "توفّي أول الخلفاء الراشدين بعد خلافةٍ دامت سنتين وثلاثة أشهر." },
  { id: "d28", monthDay: "12-26", year: "644م", era: "rashidun", title: "استشهاد عمر بن الخطاب", detail: "طعنه أبو لؤلؤة المجوسي في صلاة الفجر." },
  { id: "d29", monthDay: "01-20", year: "750م", era: "abbasid", title: "معركة الزاب الكبرى", detail: "انتصر العباسيون نهائيًا على الأمويين، وقامت الدولة العباسية." },
  { id: "d30", monthDay: "03-03", year: "1924م", era: "modern", title: "إلغاء الخلافة العثمانية", detail: "أعلن مصطفى كمال إلغاء الخلافة، فانتهت بذلك 13 قرنًا من حكم الخلفاء." },
];
...
export const BADGES = [
  ...
  { id: "streak_3", name: "ثلاثة أيام", icon: "🔥", desc: "حافظ على 3 أيام متتالية." },
  { id: "streak_7", name: "أسبوع كامل", icon: "🏅", desc: "حافظ على 7 أيام متتالية." },
  { id: "who_am_i", name: "عرّاف التاريخ", icon: "🔍", desc: "اكتشف 5 شخصيات." },
...
export const INVESTIGATIONS: Investigation[] = [
  ...
  },
  {
    ...
    clues: ["كرديّ الأصل، سلطانٌ على مصر والشام.", "أسّس الدولة الأيوبية.", "هزم الصليبيين في حِطّين.", "حرّر القدس بعد 88 سنة من الاحتلال."],
  ...
  },
  {
    ...
    clues: ["دامت أكثر من خمسة قرون.", "عاصمتها مدينة السلام.", "فيها ازدهر بيت الحكمة.", "سقطت أمام المغول عام 1258م."],
  ...
  },
  {
    ...
    clues: ["وقعت في فلسطين عام 1260م.", "قادها سلطانٌ مملوكي.", "كسرت أسطورة جيشٍ لم يُهزم.", "كان كمين بيبرس مفتاحها."],
  ...
  },
  {
    ...
    clues: ["بُنيت دائرية الشكل.", "أسّسها أبو جعفر المنصور.", "فيها قام بيت الحكمة.", "أحرقها هولاكو عام 1258م."],
...
export const DECISIONS: Decision[] = [
  {
    id: "dec-hijra", era: "seerah", setting: "مكة · العام 1 هـ",
  ...
  {
    id: "dec-yarmouk", era: "rashidun", setting: "اليرموك · 15 هـ",
    ...
    historicalNote: "قسّم خالد الجيش إلى 36 كردوسًا، فأرهق الروم ستة أيام حتى انهاروا.",
    reward: 50,
  },
  {
    id: "dec-hattin", era: "ayyubid", setting: "الجليل · 1187م",
  ...
  {
    id: "dec-fatih", era: "ottoman", setting: "أمام أسوار القسطنطينية · 1453م",
    ...
    historicalNote: "نقل الفاتح 70 سفينة برّيًّا في ليلة واحدة على ألواحٍ مدهونة بالشحم.",
    reward: 60,
  },
  {
    id: "dec-mansour", era: "abbasid", setting: "ضفاف دجلة · 145 هـ",
  ...
  {
    id: "dec-qutuz", era: "mamluk", setting: "القاهرة · 1260م",
...
export const CHARACTERS: CharacterCard[] = [
  { id: "khalid", name: "خالد بن الوليد", title: "سيف الله المسلول", era: "rashidun", rarity: "legendary", avatar: "🗡️", bio: "قائدٌ لم يُهزم في معركة، فاتح الشام والعراق.", power: "قيادة عسكرية 100" },
  { id: "omar", name: "عمر بن الخطاب", title: "الفاروق", era: "rashidun", rarity: "legendary", avatar: "⚖️", bio: "أمير المؤمنين، فاتح بيت المقدس ومؤسّس الديوان.", power: "عدل وحكمة 100" },
  { id: "muawiya", name: "معاوية بن أبي سفيان", title: "مؤسّس الأمويين", era: "umayyad", rarity: "rare", avatar: "👑", bio: "أنشأ أوّل أسطول إسلامي ونقل العاصمة إلى دمشق.", power: "سياسة 92" },
  { id: "tariq", name: "طارق بن زياد", title: "فاتح الأندلس", era: "umayyad", rarity: "rare", avatar: "🌊", bio: "أحرق السفن وفتح أبواب الأندلس.", power: "إقدام 95" },
  { id: "harun", name: "هارون الرشيد", title: "خليفة بغداد", era: "abbasid", rarity: "legendary", avatar: "🌙", bio: "في عهده بلغت بغداد ذروة مجدها.", power: "حضارة 98" },
  { id: "khwarizmi", name: "الخوارزمي", title: "أبو الجبر", era: "abbasid", rarity: "rare", avatar: "🔢", bio: "مؤسّس علم الجبر ومنه اشتُقّ اسم الخوارزميات.", power: "علم 97" },
  { id: "ibn-rushd", name: "ابن رشد", title: "شارح أرسطو", era: "andalus", rarity: "rare", avatar: "📚", bio: "فيلسوف قرطبة، عرفته أوروبا باسم Averroes.", power: "فلسفة 95" },
  { id: "abdurrahman", name: "عبد الرحمن الداخل", title: "صقر قريش", era: "andalus", rarity: "legendary", avatar: "🦅", bio: "أسّس الدولة الأموية في الأندلس بعد رحلة هرب أسطورية.", power: "إصرار 96" },
  { id: "alp-arslan", name: "ألب أرسلان", title: "بطل ملاذكرد", era: "seljuk", rarity: "rare", avatar: "🏹", bio: "أسر إمبراطور الروم وفتح باب الأناضول.", power: "بأس 93" },
  { id: "salahuddin", name: "صلاح الدين الأيوبي", title: "محرّر القدس", era: "ayyubid", rarity: "legendary", avatar: "🕌", bio: "هزم الصليبيين في حِطّين وأعاد الأذان للأقصى.", power: "نُبل 100" },
  { id: "baybars", name: "الظاهر بيبرس", title: "أسد المماليك", era: "mamluk", rarity: "legendary", avatar: "🦁", bio: "كسر المغول والصليبيين معًا وأعاد الخلافة للقاهرة.", power: "قوة 99" },
  { id: "fatih", name: "محمد الفاتح", title: "فاتح القسطنطينية", era: "ottoman", rarity: "legendary", avatar: "🏰", bio: "تحقّقت على يديه بشارة النبي ﷺ.", power: "عبقرية 100" },
];
...
STORIES.push(
  ...
  },
  {
    ...
    body: [
      "دخل صلاح الدين مصر مع عمّه شيركوه ضمن جيش نور الدين، فعُيّن وزيرًا للخليفة الفاطمي العاضد سنة 564هـ.",
      ...
      "وحين اكتملت الأدوات، التفت بصره إلى الغرب: نحو الصليبيين الذين احتلّوا القدس منذ 88 سنة.",
    ],
  },
  {
    id: "jerusalem-liberation", title: "عودة الأذان إلى الأقصى", era: "ayyubid", readMinutes: 6,
    excerpt: "في يوم الجمعة 27 رجب 583هـ، عاد الأذان إلى القدس بعد 88 عامًا من الصمت.",
    body: [
      ...
      "دخل صلاح الدين القدس في رجب 583هـ، فأعاد الصليب المعلّق على قبة الصخرة إلى موضعه الأول، وغسل المسجد بماء الورد.",
      "نُصب منبر نور الدين الذي حُمل من حلب، وارتقى الخطيب محيي الدين بن الزكي ليلقي خطبة الجمعة الأولى بعد 88 عامًا.",
  ...
  },
  {
    ...
    body: [
      ...
      "حين توفّي عام 589هـ، لم يُخلّف ذهبًا ولا فضة. لم يُجد أهله ثمن كفنه.",
...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: "ach_explore_50", name: "نصف العالم",           desc: "أكمل 50٪ من خارطة العالم.",    icon: "🧭", goal: 50 },
...
export const SEASONS: Season[] = [
  ...
  { id: "season_jerusalem",  month: 7,  name: "موسم القدس",           tagline: "اجمع 750 نقطة هذا الموسم لتنال لقب «من حُماة الأقصى».", theme: "عودة الأذان",     goalPoints: 750, endsAt: "نهاية يوليو",  reward: { points: 250, artifact: "aqsa-stone", title: "من حُماة الأقصى" }, badge: "season_jerusalem" },
...
export const MYSTERY_CHARACTERS: MysteryCharacter[] = [
  ...
  { id: "myst3", era: "ottoman",  hint: "معماريّ بنى 300 مسجد، أعظمها السليمانية." },
...
CHARACTERS.push(
  { id: "nuruddin", name: "نور الدين زنكي", title: "شيخ المجاهدين", era: "ayyubid", rarity: "rare", avatar: "🌙", bio: "وحّد الشام وزرع بذرة تحرير القدس قبل صلاح الدين.", power: "تقوى 96" },
);
...
export const FLAGSHIP_CHAPTERS: FlagshipChapter[] = [
  {
    ...
    stages: [
      { kind: "scene", title: "مشهد · بلاد ممزّقة",
        body: [
          "تفرّقت إمارات الشام بين الحكّام، والقدس بيد الفرنجة منذ 50 عامًا.",
      ...
      { kind: "decision", title: "قرار · كيف ندخل دمشق؟",
        ...
        note: "دخل نور الدين دمشق سنة 549 هـ صلحًا، فاكتملت وحدة الشام تحت رايةٍ واحدة.",
      },
      { kind: "discovery", subtype: "artifact", refId: "nuruddin-minbar",
        ...
        icon: "🕋",
        body: "بقي المنبر في حلب 22 عامًا، حتى حمله صلاح الدين إلى القدس بعد التحرير.",
      },
    ],
  ...
  },
  {
    ...
    stages: [
      ...
      { kind: "investigation", title: "تحقيق · من هذا الوزير؟",
        ...
        answerIndex: 1,
        explanation: "هو يوسف بن أيوب الملقّب بصلاح الدين، أنهى الخلافة الفاطمية سنة 567 هـ وأسّس الدولة الأيوبية.",
      },
      { kind: "decision", title: "قرار · كيف تنهي الفاطميين؟",
        setting: "القاهرة · 567 هـ",
    ...
    stages: [
      ...
      { kind: "investigation", title: "تحقيق · من هذا السلطان؟",
        ...
        clues: [
          ...
          "أعاد الأذان إلى الأقصى بعد 88 عامًا.",
    ...
    stages: [
      { kind: "scene", title: "مشهد · ليلٌ بلا نوم",
        body: [
          ...
          "أمامك جيش يضمّ 20 ألف فارس صليبي. ما خطّتك؟",
        ],
      },
  ...
  },
  {
    ...
    stages: [
      ...
      { kind: "decision", title: "قرار · كيف نعامل أهل القدس؟",
        setting: "خيمة السلطان · 21 رجب",
        scene: "أمامك خيارات. الصليبيون قتلوا أهل القدس قبل 88 عامًا حتى ركبت الخيول في الدماء.",
        choices: [
          { label: "أنتقم لما فعلوه قبل 88 عامًا", outcome: "كنت ستفقد المعنى الكبير الذي قاتلت من أجله.", correct: false },
      ...
      { kind: "discovery", subtype: "document", refId: "doc-jerusalem-khutba",
        ...
        subtitle: "بعد 88 عامًا، يرتقي محيي الدين بن الزكي منبر نور الدين.",
        icon: "📖",
  ...
  },
  {
    ...
    stages: [
      { kind: "scene", title: "مشهد · من خطبةٍ في كليرمونت إلى أذانٍ في القدس",
        body: [
          "بدأت القصة سنة 1095م بخطبةٍ للبابا أوربان الثاني في كليرمونت. وانتهت سنة 1187م بأذانٍ في الأقصى.",
...
export const CHARACTER_PROFILES: Record<string, CharacterProfile> = {
  salahuddin: {
    ...
    bioLong: [
      ...
      "في الرابع من تموز 1187م التقى الصليبيين في حِطّين، فهزمهم في يومٍ واحد، ثم دخل القدس صلحًا فعفا عن أهلها.",
      "مات فقيرًا لا يملك ما يُكفَّن به، فقد وزّع ماله كلّه على الفقراء والمجاهدين. ودُفن في دمشق بجوار الجامع الأموي.",
    ],
    timeline: [
      { year: "532 هـ", event: "وُلد في قلعة تكريت." },
      { year: "559 هـ", event: "دخل مصر مع عمّه شيركوه في جيش نور الدين." },
      { year: "564 هـ", event: "تولّى وزارة مصر بعد وفاة عمّه." },
      { year: "567 هـ", event: "أنهى الخلافة الفاطمية وأعاد الخطبة للعباسيين." },
      { year: "569 هـ", event: "تأسّست الدولة الأيوبية بعد وفاة نور الدين." },
      { year: "583 هـ", event: "هزيمة الصليبيين في حِطّين وتحرير القدس." },
      { year: "588 هـ", event: "صلح الرملة مع ريتشارد قلب الأسد." },
      { year: "589 هـ", event: "توفّي في دمشق." },
    ],
    achievements: [
      "توحيد مصر والشام تحت رايةٍ واحدة بعد قرنين من التشرذم.",
      "تحرير القدس بعد 88 سنة من الاحتلال الصليبي.",
    ...
    battles: [
      { name: "حِطّين", year: "583 هـ", place: "سهل حِطّين · فلسطين", outcome: "نصرٌ ساحق", storyId: "hattin" },
      { name: "تحرير القدس", year: "583 هـ", place: "بيت المقدس", outcome: "فتحٌ صلحًا", storyId: "jerusalem-liberation" },
      { name: "حصار عكّا", year: "585 هـ", place: "عكّا · فلسطين", outcome: "صمودٌ طويل" },
      { name: "أرسوف", year: "587 هـ", place: "ساحل فلسطين", outcome: "معركة شرسة مع ريتشارد" },
    ],
  ...
  omar: {
    ...
    lifespan: "40 ق.هـ – 23 هـ / 584 – 644 م",
    ...
    timeline: [
      { year: "بعثة 6", event: "إسلامه في مكّة." },
      { year: "1 هـ", event: "الهجرة إلى المدينة." },
      { year: "13 هـ", event: "بداية خلافته بعد أبي بكر." },
      { year: "15 هـ", event: "اليرموك والقادسية." },
      { year: "16 هـ", event: "فتح بيت المقدس صلحًا." },
      { year: "20 هـ", event: "فتح مصر على يد عمرو بن العاص." },
      { year: "23 هـ", event: "استشهاده في المحراب." },
    ],
    achievements: [
    ...
    battles: [
      { name: "اليرموك", year: "15 هـ", place: "الشام", outcome: "فتح الشام", storyId: "yarmouk" },
      { name: "القادسية", year: "15 هـ", place: "العراق", outcome: "نهاية الساسانيين", storyId: "qadisiyyah" },
      { name: "نهاوند", year: "21 هـ", place: "فارس", outcome: "فتح الفتوح" },
    ],
  ...
  khalid: {
    ...
    lifespan: "30 ق.هـ – 21 هـ / 592 – 642 م",
    birthplace: "مكّة المكرّمة",
    resting: "حمص · الشام",
    ...
    timeline: [
      { year: "3 هـ", event: "قاد فرسان قريش يوم أُحد." },
      { year: "8 هـ", event: "إسلامه." },
      { year: "8 هـ", event: "مؤتة · لُقّب بسيف الله." },
      { year: "11 هـ", event: "قيادة حروب الردّة." },
      { year: "12 هـ", event: "فتح العراق والمسيرة الأسطورية إلى الشام." },
      { year: "15 هـ", event: "قيادة اليرموك وكسر الروم." },
      { year: "21 هـ", event: "وفاته في حمص." },
    ],
    achievements: [
    ...
    battles: [
      { name: "أُحد", year: "3 هـ", place: "المدينة", outcome: "قبل إسلامه" },
      { name: "مؤتة", year: "8 هـ", place: "جنوب الشام", outcome: "انسحابٌ منظّم" },
      { name: "اليمامة", year: "12 هـ", place: "نجد", outcome: "نهاية مسيلمة" },
      { name: "اليرموك", year: "15 هـ", place: "نهر اليرموك", outcome: "كسر الروم", storyId: "yarmouk" },
    ],
  ...
  fatih: {
    ...
    lifespan: "833 – 886 هـ / 1432 – 1481 م",
    ...
    bioLong: [
      ...
      "أعدّ جيشًا قوامه 150 ألفًا، وبنى مدافع أورپان الضخمة، وحفر سفنه فوق التلال لينقلها إلى القرن الذهبي.",
      "بعد 53 يومًا من الحصار، اقتحم أسوار المدينة عند الفجر في 20 جمادى الأولى 857هـ، وصلّى في آيا صوفيا أوّل جمعة.",
      "حكم 30 سنة، فتح فيها بلادًا واسعة وأرسى نظامًا قضائيًّا وتعليميًّا بقي قرونًا.",
    ],
    timeline: [
      { year: "833 هـ", event: "وُلد في أدرنة." },
      { year: "848 هـ", event: "تولّى السلطنة لأوّل مرّة وعمره 12." },
      { year: "855 هـ", event: "تولّى السلطنة الثانية وبدأ التحضير للفتح." },
      { year: "857 هـ", event: "فتح القسطنطينية." },
      { year: "867 هـ", event: "ضمّ القرم والبوسنة." },
      { year: "886 هـ", event: "وفاته على رأس جيشٍ متوجّه إلى إيطاليا." },
    ],
    achievements: [
      ...
      "فتح أكثر من 20 ولاية أوروبية وآسيوية.",
    ],
    campaignEras: ["ottoman"],
    battles: [
      { name: "فتح القسطنطينية", year: "857 هـ", place: "القسطنطينية", outcome: "فتحٌ تاريخي", storyId: "constantinople" },
      { name: "بلغراد", year: "860 هـ", place: "صربيا", outcome: "حصار صعب" },
      { name: "أوترانتو", year: "885 هـ", place: "جنوب إيطاليا", outcome: "موطئ قدمٍ في أوروبا" },
    ],
  ...
  baybars: {
    ...
    lifespan: "620 – 676 هـ / 1223 – 1277 م",
    ...
    bioLong: [
      ...
      "بنى الأسطول، ورمّم الجوامع، وأنشأ البريد السريع بين القاهرة ودمشق في 4 أيام.",
    ],
    timeline: [
      { year: "647 هـ", event: "المنصورة · كسر حملة لويس التاسع." },
      { year: "658 هـ", event: "عين جالوت · هزيمة المغول." },
      { year: "658 هـ", event: "توليه السلطنة بعد قطز." },
      { year: "659 هـ", event: "إحياء الخلافة العباسية في القاهرة." },
      { year: "666 هـ", event: "فتح أنطاكية من الصليبيين." },
      { year: "676 هـ", event: "وفاته في دمشق." },
    ],
    achievements: [
      "أوّل هزيمة كبرى للمغول في عين جالوت.",
      "إعادة الخلافة العباسية إلى مصر.",
      "تحرير 27 مدينة وقلعة من الصليبيين.",
      "تأسيس البريد السريع وإصلاح القلاع والموانئ.",
    ],
    campaignEras: ["mamluk"],
    battles: [
      { name: "المنصورة", year: "647 هـ", place: "دلتا النيل", outcome: "أسرُ ملك فرنسا" },
      { name: "عين جالوت", year: "658 هـ", place: "فلسطين", outcome: "كسر المغول", storyId: "ain-jalut" },
      { name: "أنطاكية", year: "666 هـ", place: "شمال الشام", outcome: "تحريرها من الصليبيين" },
    ],
  ...
  harun: {
    ...
    timeline: [
      { year: "170 هـ", event: "توليه الخلافة." },
      { year: "176 هـ", event: "غزو الروم وفتح هرقلة." },
      { year: "187 هـ", event: "نكبة البرامكة." },
      { year: "193 هـ", event: "وفاته في طوس." },
    ],
    achievements: [
    ...
    battles: [
      { name: "هرقلة", year: "187 هـ", place: "الأناضول", outcome: "فتحٌ وغنائم" },
    ],
  ...
  khwarizmi: {
    ...
    timeline: [
      { year: "200 هـ", event: "انتقاله إلى بغداد." },
      { year: "212 هـ", event: "تأليف «الجبر والمقابلة»." },
      { year: "220 هـ", event: "كتاب «صورة الأرض»." },
    ],
    achievements: [
      "تأسيس علم الجبر.",
  ...
  abdurrahman: {
    ...
    bioLong: [
      ...
      "عبر إلى الأندلس، فاستقبله مواليه، ودخل قرطبة فاتحًا عام 138 هـ.",
      "أسّس الدولة الأموية في الأندلس، فبنى قرطبة وجامعها، وحكم 33 سنة حتى مماته.",
    ],
    timeline: [
      { year: "132 هـ", event: "مذبحة بني أميّة · بدء الفرار." },
      { year: "138 هـ", event: "دخوله قرطبة وتأسيس الإمارة." },
      { year: "170 هـ", event: "بدء بناء جامع قرطبة." },
      { year: "172 هـ", event: "وفاته." },
    ],
    achievements: [
      "تأسيس دولة الأمويين في الأندلس بعد سقوطها في الشرق.",
      "بناء جامع قرطبة الكبير.",
      "إرساء نظامٍ إداريّ استمرّ 300 سنة.",
    ],
    campaignEras: ["andalus", "umayyad"],
    battles: [
      { name: "المصارة", year: "138 هـ", place: "قرب قرطبة", outcome: "نصر دخل به العاصمة" },
    ],
  ...
  tariq: {
    ...
    bioLong: [
      ...
      "عبر بسبعة آلاف مقاتل إلى الأندلس عام 92 هـ، فرسا عند جبلٍ سُمّي باسمه.",
      "أحرق سفنه ليقطع التراجع، وألقى خطبته الشهيرة: «أين المفرّ؟».",
      "هزم لذريق ملك القوط في وادي لكّة، وفتح طليطلة عاصمتهم.",
    ],
    timeline: [
      { year: "92 هـ", event: "العبور إلى الأندلس." },
      { year: "92 هـ", event: "معركة وادي لكّة." },
      { year: "93 هـ", event: "فتح طليطلة." },
    ],
    achievements: [
    ...
    battles: [
      { name: "وادي لكّة", year: "92 هـ", place: "جنوب الأندلس", outcome: "نهاية القوط" },
    ],
  ...
  ibn_rushd: {
    ...
    lifespan: "520 – 595 هـ / 1126 – 1198 م",
    birthplace: "قرطبة",
    ...
    timeline: [
      { year: "565 هـ", event: "قاضي إشبيلية." },
      { year: "578 هـ", event: "تأليف «تهافت التهافت»." },
      { year: "592 هـ", event: "نفيه إلى ليسانة." },
      { year: "595 هـ", event: "وفاته في مرّاكش." },
    ],
    achievements: [
  ...
  alp_arslan: {
    ...
    lifespan: "420 – 465 هـ / 1029 – 1072 م",
    birthplace: "خراسان",
    resting: "مَرو",
    ...
    bioLong: [
      "ابن الأسرة السلجوقية، تولّى السلطنة بعد عمّه طغرلبك عام 455 هـ.",
      "اتّخذ نظام الملك وزيرًا له، فأسّسا معًا أعظم نهضة سلجوقية.",
      "في ملاذكرد عام 463 هـ هزم جيش الإمبراطور رومانوس ديوجين وأسره.",
      "اغتاله أسيرٌ أحضِر بين يديه، فمات قائلًا: «ما رفعت رأسي يومًا متكبّرًا إلّا اليوم».",
    ],
    timeline: [
      { year: "455 هـ", event: "توليه السلطنة." },
      { year: "463 هـ", event: "معركة ملاذكرد." },
      { year: "465 هـ", event: "اغتياله." },
    ],
    achievements: [
    ...
    campaignEras: ["seljuk"],
    battles: [
      { name: "ملاذكرد", year: "463 هـ", place: "شرق الأناضول", outcome: "أسر الإمبراطور" },
    ],
  ...
  muawiya: {
    ...
    lifespan: "20 ق.هـ – 60 هـ / 602 – 680 م",
    birthplace: "مكّة",
    resting: "دمشق",
    ...
    bioLong: [
      ...
      "أسّس الدولة الأموية عام 41 هـ بعد عام الجماعة، واتّخذ دمشق عاصمة.",
      "أنشأ أوّل أسطولٍ بحري إسلامي، ففتح قبرص ورودس وعبر إلى القسطنطينية.",
      "نظّم الديوان والبريد والحرس، وأرسى نظام الولاية المستقرّ.",
    ],
    timeline: [
      { year: "18 هـ", event: "ولاية الشام." },
      { year: "28 هـ", event: "فتح قبرص ببحريّته." },
      { year: "41 هـ", event: "عام الجماعة وتأسيس الدولة الأموية." },
      { year: "60 هـ", event: "وفاته." },
    ],
    achievements: [
    ...
    battles: [
      { name: "ذات الصواري", year: "34 هـ", place: "شرق المتوسط", outcome: "نصرٌ بحري ساحق" },
    ],
...
export const FOG_HINTS: Record<string, FogHint> = {
  ...
  salahuddin:   { title: "محرّر الحرم الثالث",      clue: "أعاد الأذان إلى مسجدٍ صمت 88 عامًا." },
  baybars:      { title: "أسدٌ من الرقيق",          clue: "كان عبدًا فصار سلطانًا، وكسر المغول والصليبيين معًا." },
  fatih:        { title: "الفاتح الموعود",          clue: "تحقّقت على يديه بشارةٌ نبويّة عمرها 8 قرون." },
  ...
  "b-constantinople":{ title: "حلمٌ نبويّ تحقّق",          clue: "سفنٌ مشت فوق التلال، وأسوارٌ سقطت بعد 8 قرون." },
...
export const BATTLE_PROFILES: Record<string, BattleProfile> = {
  "b-badr": {
    ...
    era: "seerah", year: "624 م", hijri: "17 رمضان 2 هـ",
    location: "وادي بدر · الحجاز", coords: { x: 50, y: 60 },
    heroGradient: "from-amber-500/40 via-gold/20 to-transparent", hero: "🌟",
    overview: [
      "أوّل معركةٍ فاصلة في تاريخ الإسلام، التقى فيها 313 من المسلمين بـ 1000 من قريش.",
      "نزل المسلمون عند الماء، وحُرم العدوّ منه، فكانت الأرض والسماء معهم.",
    ],
    sides: [
      { name: "المسلمون", commander: "النبي محمد ﷺ", strength: "313 مقاتلًا · 70 بعيرًا · فرسان", flag: "🟢" },
      { name: "قريش",     commander: "أبو جهل بن هشام", strength: "نحو 1000 مقاتل · 100 فرس · 700 بعير", flag: "⚫" },
    ],
    timeline: [
    ...
    outcome: [
      "نصرٌ ساحق رغم الفارق العددي 3 إلى 1.",
  ...
  "b-yarmouk": {
    ...
    era: "rashidun", year: "636 م", hijri: "رجب 15 هـ",
    ...
    sides: [
      { name: "المسلمون", commander: "خالد بن الوليد", strength: "نحو 36 ألفًا", flag: "🟢" },
      { name: "بيزنطة",  commander: "ماهان الأرمني",    strength: "بين 100 و200 ألف", flag: "🟡" },
    ],
    timeline: [
  ...
  "b-qadisiyyah": {
    ...
    era: "rashidun", year: "636 م", hijri: "15 هـ",
    ...
    sides: [
      { name: "المسلمون", commander: "سعد بن أبي وقّاص", strength: "نحو 30 ألفًا", flag: "🟢" },
      { name: "الفرس",   commander: "رستم فرّخزاد",       strength: "نحو 120 ألفًا · فيلة", flag: "🔴" },
    ],
    timeline: [
  ...
  "b-manzikert": {
    ...
    era: "seljuk", year: "1071 م", hijri: "463 هـ",
    ...
    sides: [
      { name: "السلاجقة", commander: "ألب أرسلان", strength: "نحو 40 ألف فارس", flag: "🟢" },
      { name: "بيزنطة",  commander: "رومانوس الرابع ديوجين", strength: "نحو 70 ألفًا", flag: "🟡" },
    ],
    timeline: [
  ...
  "b-hattin": {
    ...
    era: "ayyubid", year: "1187 م", hijri: "24 ربيع الآخر 583 هـ",
    ...
    sides: [
      { name: "الأيوبيون", commander: "السلطان صلاح الدين الأيوبي", strength: "نحو 30 ألفًا · فرسان وخيّالة سريعة", flag: "🟢" },
      { name: "مملكة بيت المقدس الصليبيّة", commander: "غاي دي لوزنيان · ريموند الثالث", strength: "نحو 20 ألفًا · 1200 فارس مدرّع", flag: "✝️" },
    ],
    timeline: [
    ...
    impact: [
      "تحرير القدس بعد 88 عامًا من الاحتلال الصليبي.",
  ...
  "b-ain-jalut": {
    ...
    era: "mamluk", year: "1260 م", hijri: "25 رمضان 658 هـ",
    ...
    sides: [
      { name: "المماليك",  commander: "السلطان قطز · الظاهر بيبرس", strength: "نحو 20 ألفًا", flag: "🟢" },
      { name: "المغول",    commander: "كتبغا نوين",                  strength: "نحو 10–20 ألفًا", flag: "⚪" },
    ],
    timeline: [
  ...
  "b-constantinople": {
    ...
    era: "ottoman", year: "1453 م", hijri: "20 جمادى الأولى 857 هـ",
    location: "القسطنطينية · مضيق البوسفور", coords: { x: 55, y: 47 },
    heroGradient: "from-rose-600/30 via-gold/30 to-transparent", hero: "🏰",
    overview: [
      "حاصر السلطان محمد الثاني المدينة وعمره 21 سنة، بعد أن جهّز أعظم مدافع عصره.",
      "نقل أسطوله فوق التلال إلى القرن الذهبي، واقتحم أسوارًا صمدت 1100 عامٍ في فجر الثلاثاء 29 مايو.",
    ],
    sides: [
      { name: "العثمانيون", commander: "السلطان محمد الثاني الفاتح", strength: "نحو 80 ألفًا · مدفع أورپان · أسطول 126 سفينة", flag: "🟢" },
      { name: "بيزنطة",    commander: "قسطنطين الحادي عشر",         strength: "نحو 7000 مدافع · 26 سفينة", flag: "🟡" },
    ],
    timeline: [
      { phase: "التحضير",  detail: "بناء قلعة روملي حصار للسيطرة على البوسفور." },
      { phase: "بدء الحصار", detail: "في 6 أبريل 1453 بدأ القصف بمدفع أورپان الضخم." },
      { phase: "نقل السفن", detail: "ليلًا، جُرّت 70 سفينة فوق التلال إلى القرن الذهبي." },
      { phase: "الاقتحام النهائي", detail: "فجر 29 مايو، اقتحم الإنكشاريّة الثغرات بقيادة أولوباطلي حسن." },
    ...
    outcome: [
      "سقوط الإمبراطوريّة البيزنطيّة بعد 1100 سنة.",
