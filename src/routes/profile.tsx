...
// import { AccountDiagPanel } from "@/components/AccountDiagPanel"; // Already added manually in earlier step, will keep only one
import {
...
function OverviewTab({
  profile, views, onSeeAllAchievements,
}: {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Current-season card removed in Phase 3B — Seasons demo deleted. */}
