        ...
        <div dir={dir} className={ar ? "text-right" : "text-left"}>
          <div className="rounded-3xl border border-gold/25 bg-surface p-5 text-center">
            ...
            >
              ...
              {ar ? "نعود إلى التشخيص:\nنفّذ الإصلاحين 1 و2 فقط الآن، لأنهما أقل مخاطرة وأعلى أثر، وبدون أي تعديل آخر خارج نطاقهما.\n1) إعادة الحملات إلى Local-first\nأزل الانتظار المتزامن على:\n\n\nawait refreshCampaignRows()\n\n\nمن مسار بناء وعرض حملات المستخدم.\nالسلوك المطلوب:\nحمّل الـSnapshot المحلي.\nابنِ الأقسام والفواصل واعرض الحملات فورًا.\nشغّل refreshCampaignRows() في الخلفية.\nبعد وصول البيانات الحية:\nادمجها محليًا.\nحدّث الواجهة بهدوء.\nلا تُظهر Loading جديدًا.\nلا تعيد ترتيب الصفحة بشكل مزعج.\nإذا فشل التحديث الحي:\nتبقى النسخة المحلية ظاهرة وصالحة.\nلا تتحول الصفحة إلى خطأ.\nحافظ على ترتيب لوحة الإدارة والفواصل ونظام فتح أول حملة في كل عصر.\nأضف staleTime مناسبًا لاستعلام الحملات حتى لا يعيد الجلب عند كل دخول وخروج بلا داعٍ.\n2) تأجيل وضبط تسخين كاش الصور\nلا تطلق 375 طلب صورة معًا أثناء أول تشغيل.\nالمطلوب:\nابدأ تسخين الصور فقط بعد ظهور المحتوى الأساسي.\nاستخدم requestIdleCallback إن كان متاحًا، أو fallback مؤجلًا.\nحدّ التزامن إلى 4–6 طلبات فقط.\nأعطِ الأولوية للصور الظاهرة حاليًا:\nHero.\nأول بطاقات الحملات.\nالتحديات الظاهرة.\nباقي الصور تُسخّن تدريجيًا بالخلفية.\nعند ضعف الشبكة أو saveData:\nخفّض التزامن.\nأو أوقف التسخين غير الضروري.\nلا تجعل فشل صورة يعيد المحاولة بلا حدود.\nلا تجعل الصور تزاحم طلبات JSON الأساسية.\nقياس قبل/بعد\nبعد التنفيذ أريد أرقامًا حقيقية لنفس السيناريوهات:\nTime to Campaign Cards.\nTime to Home Hero النهائي.\nTime to Daily Challenges.\nعدد طلبات REST.\nحجم البيانات المنقولة.\nأبطأ طلب.\nعدد طلبات الصور المتزامنة.\nهل بقي أي 500 أو timeout.\nمعايير النجاح\nحملات الـSnapshot تظهر خلال أقل من ثانية تقريبًا.\nلا تنتظر صفحة الحملات Supabase حتى تظهر.\nلا يحصل Layout Jump مزعج بعد وصول البيانات الحية.\nHero الرئيسية يظهر بسرعة ولا يتغير بعد 13 ثانية.\nتحديات اليوم تظهر خلال وقت قصير.\nلا يُطلق أكثر من 6 طلبات صور متزامنة.\nلا يتغير أي منطق للحملات أو التحديات أو التقدم أو الأوفلاين.\nبعد إنهاء هذين الإصلاحين، قدّم النتائج فقط، ولا تنفّذ البنود 3–8 إلا بعد أن نراجع أثر المرحلة الأولى." : "النسخة العربية"}
            </button>
          </div>
