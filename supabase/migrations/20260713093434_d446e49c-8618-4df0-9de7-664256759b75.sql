...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pgmq.q_auth_emails)
     AND NOT EXISTS (SELECT 1 FROM pgmq.q_auth_emails_custom)
    ...
    BEGIN
      ...
      IF EXISTS (SELECT 1 FROM pgmq.q_auth_emails)
         OR EXISTS (SELECT 1 FROM pgmq.q_auth_emails_custom)
  ...
  PERFORM net.http_post(
    url := 'https://project--31875359-3432-4659-ac2f-cf9396a444ee.lovable.app/lovable/email/queue/process',
...
DROP TRIGGER IF EXISTS email_queue_wake_auth_custom ON pgmq.q_auth_emails_custom;
CREATE TRIGGER email_queue_wake_auth_custom
AFTER INSERT ON pgmq.q_auth_emails_custom
FOR EACH STATEMENT
